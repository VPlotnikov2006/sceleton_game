...
//Global variables
//{=====================================================================================================================
char back_name[3][16] = {"background1.bmp",
                         "background2.bmp",
                         "background3.bmp"};
char back_collision_name[3][26] = {"background1_collision.txt",
...
struct Background
{
    ...
    ///     \ingroup    File
    ///
    ///     \brief      Грузит картинку из файла name + num + ".bmp"
    ///
    ///     \warning    Если такого файла нет то - Undefined Behavior
    ///
    ///     \return     True если удачная загрузка, False если нет такого файла
    ...
    ///     \ingroup    File
    ///
    ///     \brief      Считывает коллизию блоков из файла name + "_collision.txt"
    ///
    ///     \warning    Если такого файла нет то - Undefined Behavior
    ///
    ///     \return     True если удачная загрузка, False если нет такого файла
...
{
    picture = txLoadImage(back_name[num]);
    if (!picture)
    {
        txMessageBox("Ошибка","Не найден файл с персонажем");
        return 0;
...
bool Background::load_collision()
{
...
{
    txBitBlt(txDC(), 0, 0, xsize, ysize, picture);
}
//}=====================================================================================================================
