...
//Bot
//{=====================================================================================================================
void Bot::screamer(ch_t &ch)
{
    int x = ch.get_xpos(), y = ch.get_ypos();
    int area = 50;
    int x1 = xpos - area;
    int x2 = xpos + area;
    int y1 = ypos - area;
    int y2 = ypos + area;
    if (x1 < x && x < x2 && y1 < y && y < y2 && scr == 0)
    {
        Win32::TransparentBlt(txDC(),0,0, 1080,1080,picture, 0, 96, 48,48,RGB(254,254,255));
        //scr = 1;
        txSleep(500);
        xpos = -100;
        ypos = -100;
